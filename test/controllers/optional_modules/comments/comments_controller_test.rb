...
class CommentsControllerTest < ActionController::TestCase
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: nil }, locale: locale.to_s }
        end
  ...
  test 'should not be able to create comment if captcha is filled' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', nickname: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'should not be able to create comment if lang is not set' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw' }, locale: locale.to_s }
        end
        assert_not assigns(:comment).valid?
      end
    end
  ...
  test 'should not be able to create comment if lang is not allowed' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: 'ch' }, locale: locale.to_s }
        end
        assert_not assigns(:comment).valid?
      end
    end
  ...
  test 'should not be able to create comment if email is not valid' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', nickname: '', username: 'leila', email: 'not_valid', lang: locale.to_s }, locale: locale.to_s }
        end
        assert_not assigns(:comment).valid?
      end
    end
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }
        end
  ...
  test 'should create comment only with comment field if connected' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_difference 'Comment.count' do
          post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', lang: locale.to_s }, locale: locale.to_s }
        end
        assert assigns(:comment).valid?
        assert_redirected_to blog_category_blog_path(@blog_mc.blog_category, @blog_mc)
      end
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        assert_enqueued_jobs 1 do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should send created email if send_email and not connected' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        assert_enqueued_jobs 1 do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'should send created email if send_email and connected as subscriber' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        assert_enqueued_jobs 1 do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', lang: locale.to_s }, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should send created email if send_email and connected as subscriber' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        assert_enqueued_jobs 1 do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', lang: locale.to_s }, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'AJAX :: should create comment' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        post :create, params: { format: :js, blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }, xhr: true
  ...
  test 'AJAX :: should not create comment if nickname is filled' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { format: :js, blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', nickname: 'robot', lang: locale.to_s }, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'should not be able to delete comments if user is not logged in' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          delete :destroy, params: { id: @comment_alice, blog_id: @blog_mc.id, locale: locale.to_s }
    ...
    if @locales.include?(:fr)
      ...
      I18n.with_locale(locale) do
        assert_difference 'Comment.count', -1 do
          delete :destroy, params: { id: @comment_alice, blog_id: @blog_mc.id, locale: locale }
  ...
  test 'subscriber should not be able to delete except his own' do
    ...
    I18n.with_locale(locale) do
      assert_difference 'Comment.count', -1 do
        delete :destroy, params: { id: @comment_lana, blog_id: @blog_mc.id, locale: locale }
        assert_equal I18n.t('comment.destroy.success'), flash[:success]
      end
  ...
  test 'administrator should be able to delete comments except SA' do
    ...
    I18n.with_locale(locale) do
      ...
      assert_no_difference 'Comment.count' do
        delete :destroy, params: { id: @comment_anthony, blog_id: @blog_mc.id, locale: locale }
        assert_equal I18n.t('comment.destroy.not_allowed'), flash[:error]
      end
    end
  end
  ...
  test 'should destroy comment with children if any' do
    ...
    assert_difference 'Comment.count', -4 do
      delete :destroy, params: { id: @comment_lana, blog_id: @blog_mc.id, locale: 'fr' }
    end
  end
  ...
  test 'AJAX :: should destroy comment with children if any' do
    ...
    assert_difference 'Comment.count', -4 do
      delete :destroy, params: { format: :js, id: @comment_lana, blog_id: @blog_mc.id, locale: 'fr' }
    end
  end
  ...
  test 'should have correct flash if should validate and logged in as admin' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale.to_s) do
        post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', user_id: @administrator.id, lang: locale.to_s }, locale: locale.to_s }
  ...
  test 'should have correct flash if should validate and logged in as subscriber' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale.to_s) do
        post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', user_id: @subscriber.id, lang: locale.to_s }, locale: locale.to_s }
  ...
  test 'AJAX :: should have correct flash if should validate' do
    @locales.each do |locale|
      I18n.with_locale(locale.to_s) do
        post :create, params: { blog_id: @blog_mc.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s }, locale: locale.to_s }, xhr: true
        assert_equal I18n.t('comment.create_success_with_validate'), flash[:success]
      end
    end
  end
  ...
  test 'should signal comment' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        get :signal, params: { token: @comment_alice.token, blog_id: @blog_mc.id, id: @comment_alice, locale: locale.to_s }
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :signal, params: { id: 999_999, token: @comment_alice.token, blog_id: @blog_mc.id, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'should render 404 if token not set for signal' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :signal, params: { id: @comment_alice, blog_id: @blog_mc.id, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'should send email to admin after signalling email' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        ...
        assert_enqueued_jobs 1 do
          get :signal, params: { id: @comment_alice, token: @comment_alice.token, blog_id: @blog_mc.id, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should signal comment' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        get :signal, params: { format: :js, id: @comment_luke.id, token: @comment_luke.token, blog_id: @blog_mc.id, locale: locale.to_s }, xhr: true
        assert_response :success
        assert assigns(:comment).signalled?
      end
    end
  ...
  test 'AJAX :: should render 404 if token not set for signal' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :signal, params: { format: :js, id: @comment_luke.id, blog_id: @blog_mc.id, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'should render reply template and success response' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        # About article
        get :reply, params: { token: @comment_alice.token, blog_id: @blog_mc.id, id: @comment_alice, locale: locale.to_s }
        assert_response :success
        assert_template :reply

        # Blog article
        get :reply, params: { token: @comment_blog.token, blog_id: @blog.id, id: @comment_blog, locale: locale.to_s }
        assert_response :success
        assert_template :reply
      end
    end
  ...
  test 'should render 404 if token not set for reply' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :reply, params: { token: '', id: @comment_alice, blog_id: @blog_mc.id, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should render reply template and success response' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        # About article
        get :reply, params: { format: :js, id: @comment_alice.id, token: @comment_alice.token, blog_id: @blog_mc.id, locale: locale.to_s }, xhr: true
        assert_response :success
        assert_template :reply

        # Blog article
        get :reply, params: { format: :js, token: @comment_blog.token, blog_id: @blog.id, id: @comment_blog, locale: locale.to_s }, xhr: true
        assert_response :success
        assert_template :reply
      end
    end
  ...
  test 'should save children of a comment' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        post :create, params: { blog_id: @blog_mc.id, id: @comment_alice, comment: { parent_id: @comment_alice.id }, locale: locale.to_s }
  ...
  test 'AJAX :: should render 404 if token not set for reply' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :reply, params: { token: '', id: @comment_luke.id, blog_id: @blog_mc.id, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'should not be able to access reply to comment if allow_reply is disabled' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :reply, params: { token: @comment_luke.token, id: @comment_luke.id, blog_id: @blog_mc.id, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should not be able to access reply to comment if allow_reply is disabled' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_raises(ActionController::RoutingError) do
          get :reply, params: { token: @comment_luke.token, id: @comment_luke.id, blog_id: @blog_mc.id, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
  ...
  test 'AJAX :: should not be able to create reply to comment if allow_reply is disabled' do
    ...
    @locales.each do |locale|
      I18n.with_locale(locale) do
        post :create, params: { blog_id: @blog_mc.id, id: @comment_alice, comment: { parent_id: @comment_alice.id }, locale: locale.to_s }, xhr: true
        assert_nil assigns(:comment).parent_id
      end
    end
  end
  ...
  test 'should not be able to create reply to comment if depth is already max' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s, parent_id: @max_depth.id }, locale: locale.to_s }
        end
      end
    end
  end
  ...
  test 'AJAX :: should not be able to create reply to comment if depth is already max' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        assert_no_difference 'Comment.count' do
          post :create, params: { blog_id: @blog.id, comment: { comment: 'youpi', username: 'leila', email: 'leila@skywalker.sw', lang: locale.to_s, parent_id: @max_depth.id }, locale: locale.to_s }, xhr: true
        end
      end
    end
  end
