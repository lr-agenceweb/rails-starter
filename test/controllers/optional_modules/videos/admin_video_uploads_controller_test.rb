...
module Admin
  ...
  class VideoUploadsControllerTest < ActionController::TestCase
    ...
    test 'should get show page if logged in' do
      get :show, params: { id: @video_upload }
      assert_response :success
    end

    test 'should get edit page if logged in' do
      get :edit, params: { id: @video_upload }
      assert_response :success
    end
    ...
    test 'should destroy VideoUpload' do
      assert_difference 'VideoUpload.count', -1 do
        delete :destroy, params: { id: @video_upload }
      end
    ...
    test 'should return correct value for toggle_online batch action' do
      post :batch_action, params: { batch_action: 'toggle_online', collection_selection: [@video_upload.id] }
    ...
    test 'should return correct flash content after updating an video_upload file' do
      ...
      patch :update, params: { id: @video_upload, video_upload: { video_file: video_upload } }
    ...
    def disable_video_upload_settings
      ...
      patch :update, params: { id: @video_settings, video_setting: { video_upload: '0' } }
