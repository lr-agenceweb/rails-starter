...
class BlogCategoriesControllerTest < ActionController::TestCase
  ...
  test 'should get show' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        get :show, params: { locale: locale.to_s, id: @blog_category }
  ...
  test 'AJAX :: should get show' do
    @locales.each do |locale|
      I18n.with_locale(locale) do
        get :show, params: { locale: locale.to_s, id: @blog_category }, xhr: true
        assert_response :success
        assert_not_nil assigns(:blogs)
    ...
    @locales.each do |locale|
      I18n.with_locale(locale.to_s) do
        assert_raises(ActiveRecord::RecordNotFound) do
          get :show, params: { locale: locale.to_s, id: 'foobar' }
        end
      end
    end
  end
