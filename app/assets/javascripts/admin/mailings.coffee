...
set_selection_buttons = ->
  if $('form.formtastic.mailing_message').length
    $select_btns = $('<div class="actions-customers"><div class="select-btn-container"><a class="button select_all">Sélectionner tous le monde</a><a class="button select_none">Désélectionner tous le monde</a></div></div>')
