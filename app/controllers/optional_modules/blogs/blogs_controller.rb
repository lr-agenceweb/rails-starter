...
class BlogsController < ApplicationController
  ...
  # GET /blog.json
  def index
    @blogs = Blog.includes(:translations, :user, :picture, :video_uploads, :video_platforms, blog_category: [:translations], referencement: [:translations]).published.order(created_at: :desc)
