...
namespace :core do
  namespace :upload do
    ...
    task :yml do # cap <env> core:upload:yml
      on roles(:app) do
    ...
    task :dkim do # cap <env> core:upload:dkim
      on roles(:app) do
    ...
    task :missing do # cap <env> core:upload:missing
      on roles(:app) do
    ...
    task :seeds do # cap <env> core:upload:seeds
      on roles(:app) do
    ...
    task :all do # cap <env> core:upload:all
      invoke 'upload:yml'
      invoke 'upload:dkim'
